 ...
 */
  ...
  abstract class AbstractHttpRequestAdapterTest extends TestCase {
    ...
    public function getQueryString() {
      $queryString= 'product1=name%26name&product2=test%26test';
      $this->request->setURL(new HttpScriptletURL(sprintf('http://localhost/some/path?%s', $queryString)));
      $this->request->env['QUERY_STRING']=$queryString;
      
      $this->assertEquals($queryString, $this->fixture->getQueryString());
